...
<p> 
    <input id="welcomeio-feedbackLink" value="Get Feedback" type="button" /> 
    <input id="welcomeio-newInstanceLink" value="Reset Problem" type="button" /> 
</p> 
...
(function(){
  ...
  var parsonsPuzzle = new ParsonsWidget({
    ...
    "lang": "en",
    "show_feedback": true,
    "trashId": "welcomeio-sortableTrash"
  });
  parsonsPuzzle.init(initial);
  parsonsPuzzle.shuffleLines();
  $("#welcomeio-newInstanceLink").click(function(event){ 
      event.preventDefault(); 
      parsonsPuzzle.shuffleLines(); 
  }); 
  $("#welcomeio-feedbackLink").click(function(event){ 
      event.preventDefault(); 
